...
class PageInfo extends StatefulWidget {
  ...
  const PageInfo({Key? key, required this.item, required this.child}) : super(key: key);
  @override
  _PageInfoState createState() => _PageInfoState();

  static PageInfo? of(BuildContext context) => context.findAncestorStateOfType<_PageInfoState>()?.widget;
}
