...
class _PaginatedDataTable extends StatefulWidget {
  ...
  /// and no affordable will be provided to change the value.
...
class _PaginatedDataTableState extends State<_PaginatedDataTable> {
